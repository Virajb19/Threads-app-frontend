...
export default function SignUpPage() {
    ...
    return <main className="bg-black w-full min-h-screen flex-center">
             ...
             <div className="flex flex-col z-10 p-1 gap-1 w-[30%] mb:w-full tb:w-1/2 items-center">
               ...
               <a href="/login" className="text-[#777777] text-sm mt-3 tracking-normal">Already have an account ? <span className="text-white font-medium hover:underline hover:underline-offset-2">Sign in</span></a>
          </div>
        </main>
}